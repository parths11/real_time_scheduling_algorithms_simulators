...
#define Value 			7
#define	actual_id		8
//#define value_density	9

//stucture of the task
typedef struct
{
	int T[9],instance,alive;
	float value_density;
/*
...
//int max(task *t1,int n,int p);				//Find minimum of given task parameter
int max(task *t1,int n,float value_density);				//Find minimum of given task parameter
