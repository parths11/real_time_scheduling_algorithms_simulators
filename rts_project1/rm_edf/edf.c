...
FILE* filepointer;
	...
	line[1024]='\0';
	int label;
	filepointer=fopen("/home/parth/Desktop/rts_project1/rm_edf/question1_taskset_overload.txt","r"); /*put path to the input folder here*/
if (filepointer==NULL)
{
...
for(k=0;k<n;k++)
	drop[k]=0;
FILE* filepointer2;
filepointer2=fopen("/home/parth/Desktop/rts_project1/rm_edf/edfoutput.txt","w"); /*put path to the output folder here*/
